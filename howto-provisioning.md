...
Provision a {{site.data.keyword.databases-for-mysql_full}} deployment through the [catalog](https://cloud.ibm.com/databases/databases-for-mysql/create){: external}, the [{{site.data.keyword.databases-for}} CLI plug-in](/docs/databases-cli-plugin?topic=databases-cli-plugin-cdb-reference){: external}, the [{{site.data.keyword.databases-for}} API](https://cloud.ibm.com/apidocs/cloud-databases-api/cloud-databases-api-v5){: external}, or through [Terraform](https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/database){: external}.
...
1. Provision a {{site.data.keyword.databases-for-mysql}} Shared instance with a command like:
   ...
   Provision a {{site.data.keyword.databases-for-mysql}} Isolated instance with the same `"members_host_flavor"` -p flag, and then specify the `host_flavor value` parameter. For example: `{"members_host_flavor": "b3c.4x16.encrypted"}`
...
{: note}
   ...
   Name:                INSTANCE_NAME
   ID:                  crn:v1:bluemix:public:databases-for-mysql:us-east:a/   40ddc34a846383BGB5b60e:dd13152c-fe15-4bb6-af94-fde0af5303f4::
...
1. To check provisioning status, use the following command:
   ...
   Name:                  INSTANCE_NAME
   ID:                    crn:v1:bluemix:public:databases-for-mysql:us-east:a/40ddc34a953a8c02f109835656860e:dd13152c-fe15-4bb6-af94-fde0af5303f4::
