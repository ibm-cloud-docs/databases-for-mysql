...
After the promotion is complete, you can switch your applications to connect to your {{site.data.keyword.databases-for-mysql}} deployment and get back up and running.
