...
As noted in that [Connecting with `psql`](/docs/databases-for-mysql?topic=databases-for-mysql-connecting-psql) documentation, the {{site.data.keyword.databases-for}} CLI plug-in simplifies connecting. The previous `psql` import can be performed as:
